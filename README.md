...
git clone https://github.com/abdelalimah/workspaceAutomater.git && sudo zsh workspaceAutomater/automater.sh setup && chmod +x  workspaceAutomater/automater.sh && cd && rm -rf workspaceAutomater
